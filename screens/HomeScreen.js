...
const HomeScreen = () => {
  ...
  useLayoutEffect(() => {  //For layout styling
    navigation.setOptions({
      headerShown: true, title: "Dunki'n Den",
      headerTitleStyle: {
        fontSize: 20,
        fontWeight: "bold",
        color: "white",
  ...
  return (
    <>
      <View>
        <Header />
        <ScrollView>
          <View style={{ margin: 17, borderColor: "#FFC72C", borderWidth: 1, borderRadius: 6 }}>
            {/* Destination */}
            <Pressable onPress={()=>navigation.navigate("Search")} style={{ flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 10, borderColor: "#FFC72C", borderWidth: 2, paddingVertical: 15 }}>
              ...
              <TextInput placeholderTextColor="black" placeholder={route?.params ? route.params.input :"Enter Your Destination" }></TextInput>
            </Pressable>
            ...
            {/* No of guests */}
            <Pressable onPress={() => setModalVisibile(!modalVisibile)} style={{ flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 10, borderColor: "#FFC72C", borderWidth: 2, paddingVertical: 15 }}>
              <Ionicons name="person-outline" size={24} color="black" />
              <TextInput placeholderTextColor="red" placeholder={`${rooms} Room + ${adults} Adults + ${childrens} Childrens`} />
            </Pressable  >
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            ...
            >
              ...
              <Text style={{ color: "white", fontSize: 15, fontWeight: "500" }}>
                You are at a genius level one in our loyalty program
              </Text>
            </Pressable>
      ...
      >
        <ModalContent style={{ width: "100%", height: 310 }}>
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 16, fontWeight: "500" }}>Children's</Text>

            <Pressable style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>

              <Pressable
                onPress={() => setChildrens(Math.max(1, rooms - 1))}
                style={{
                  width: 26,
                  height: 26,
                  borderRadius: 13,
